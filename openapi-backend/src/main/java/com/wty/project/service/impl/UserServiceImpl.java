...
import static com.wty.project.constant.UserConstant.ADMIN_ROLE;
import static com.wty.project.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
     ...
     * 盐值，混淆密码
     */
    private static final String SALT = "wty";
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        synchronized (userAccount.intern()) {
            ...
            // 3.创建一个accessKey、secretKey
            String accessKey = DigestUtil.md5Hex("userAccount" + RandomUtil.randomNumbers(5));
            String secretKey = DigestUtil.md5Hex("userAccount" + RandomStringUtils.random(8));
