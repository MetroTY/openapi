...
import com.openapi.model.params.WebFaviconIconParams;
import com.openapi.model.response.*;
import com.wty.utils.RequestUtils;
...
public class InterfaceController {
    ...
    public LoveTalkResponse getLoveTalk() {
        String loveTalk = RequestUtils.get("https://api.vvhan.com/api/text/love");
